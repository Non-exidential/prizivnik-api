...
class AddConscript extends Component{
    constructor(props) {
        super(props);
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-12">
                                <h3 className="text-center">Добавить призывника</h3>
                            </div>
                        </div>
                        <div className="row">
                            <div className="col-6 offset-3">
                                <form onSubmit={(e) => this.onSubmit(e)}>
                                    ...
                                    <MDBInput label="Дата рождения" name="birth" type="date" onChange={(e) => this.onChange(e)}/>
                                    ...
                                    <MDBInput label="Год призыва" name="year_of_call" type="number" max={2020} onChange={(e) => this.onChange(e)}/>
